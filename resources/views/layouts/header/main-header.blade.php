				...
				<div class="container-fluid">
					<div class="main-header-left ">
						<div class="responsive-logo">
							<a href="{{ url('/' . $page='index') }}"><img src="{{asset('assets/img/logo.png')}}" class="logo-1" alt="logo"></a>
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								...
								<div class="dropdown-menu">
									...
									<form action="{{route('logout')}}" method="POST">
										@csrf
										@method('POST')
									<button type="submit" class="dropdown-item" href="{{ url('/' . $page='page-signin') }}"><i class="bx bx-log-out"></i> Sign Out</button>
									</form>
								</div>
							</div>
